...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Application', 'model/Attachment', 'model/Server', 'model/Technology', 'model/Ticket', 'model/TicketMessage', 'model/UpdateMultipleStatuses', 'model/User', 'api/DefaultApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Application'), require('./model/Attachment'), require('./model/Server'), require('./model/Technology'), require('./model/Ticket'), require('./model/TicketMessage'), require('./model/UpdateMultipleStatuses'), require('./model/User'), require('./api/DefaultApi'));
  }
}(function(ApiClient, Application, Attachment, Server, Technology, Ticket, TicketMessage, UpdateMultipleStatuses, User, DefaultApi) {
  'use strict';
